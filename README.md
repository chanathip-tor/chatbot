...
<video src="https://github.com/<your-username>/<your-repo>/blob/main/demo-ai-assistant.mov?raw=true" controls width="720"></video>

Alternatively, you can click the thumbnail below:

[![Watch the Demo](assets/demo-thumbnail.png)](https://github.com/<your-username>/<your-repo>/blob/main/demo-ai-assistant.mov?raw=true)